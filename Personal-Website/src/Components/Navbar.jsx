        ...
        <>
            <nav className='flex justify-between items-center p-10 z-10 absolute w-full'>
                ...
                <ul className='flex justify-center items-center gap-2'>
                    ...
                    <li><button className='text-white bg-neutral-primary border-2 border-white hover:bg-gray-200/25 font-medium leading-5 rounded-full text-m px-4 py-1'>Expertise</button></li>
